...
export type GetPokemonTypesQuery = {
  __typename?: 'Query';
...
export function useUnFavoritePokemonMutation(
  ...
  return Apollo.useMutation<
    UnFavoritePokemonMutation,
    UnFavoritePokemonMutationVariables
  >(UnFavoritePokemonDocument, options);
}
export type UnFavoritePokemonMutationHookResult = ReturnType<
  typeof useUnFavoritePokemonMutation
>;
export type UnFavoritePokemonMutationResult =
  Apollo.MutationResult<UnFavoritePokemonMutation>;
...
export function useGetPokemonByIdQuery(
  ...
  const options = {...defaultOptions, ...baseOptions};
  return Apollo.useQuery<GetPokemonByIdQuery, GetPokemonByIdQueryVariables>(
...
export function useGetPokemonByIdLazyQuery(
  ...
  const options = {...defaultOptions, ...baseOptions};
  return Apollo.useLazyQuery<GetPokemonByIdQuery, GetPokemonByIdQueryVariables>(
    GetPokemonByIdDocument,
    options,
  );
}
...
export type GetPokemonByIdQueryResult = Apollo.QueryResult<
  ...
  GetPokemonByIdQueryVariables
>;
export function refetchGetPokemonByIdQuery(
  variables: GetPokemonByIdQueryVariables,
) {
...
export function useGetPokemonByNameQuery(
  ...
  const options = {...defaultOptions, ...baseOptions};
  return Apollo.useQuery<GetPokemonByNameQuery, GetPokemonByNameQueryVariables>(
...
export type GetPokemonByNameQueryResult = Apollo.QueryResult<
  ...
  GetPokemonByNameQueryVariables
>;
export function refetchGetPokemonByNameQuery(
  variables: GetPokemonByNameQueryVariables,
) {
 ...
 * });
 */
export function useGetPokemonTypesQuery(
  baseOptions?: Apollo.QueryHookOptions<
  ...
  const options = {...defaultOptions, ...baseOptions};
  return Apollo.useQuery<GetPokemonTypesQuery, GetPokemonTypesQueryVariables>(
    GetPokemonTypesDocument,
    options,
  );
}
export function useGetPokemonTypesLazyQuery(
  baseOptions?: Apollo.LazyQueryHookOptions<
    GetPokemonTypesQuery,
    GetPokemonTypesQueryVariables
  >,
  ...
  return Apollo.useLazyQuery<
    GetPokemonTypesQuery,
    GetPokemonTypesQueryVariables
  >(GetPokemonTypesDocument, options);
}
export type GetPokemonTypesQueryHookResult = ReturnType<
  typeof useGetPokemonTypesQuery
>;
export type GetPokemonTypesLazyQueryHookResult = ReturnType<
  typeof useGetPokemonTypesLazyQuery
>;
export type GetPokemonTypesQueryResult = Apollo.QueryResult<
  GetPokemonTypesQuery,
  GetPokemonTypesQueryVariables
>;
export function refetchGetPokemonTypesQuery(
  variables?: GetPokemonTypesQueryVariables,
) {
...
export function useFavoritePokemonMutation(
  ...
  return Apollo.useMutation<
    FavoritePokemonMutation,
    FavoritePokemonMutationVariables
  >(FavoritePokemonDocument, options);
}
export type FavoritePokemonMutationHookResult = ReturnType<
  typeof useFavoritePokemonMutation
>;
export type FavoritePokemonMutationResult =
  Apollo.MutationResult<FavoritePokemonMutation>;
